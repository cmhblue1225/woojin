...
> **최종 업데이트**: 2025.07.28 - 도메인별 임베딩 시스템 완성
...
- **📚 고도화된 RAG 시스템**: OpenAI text-embedding-3-small + Supabase pgvector
- **🌐 전체 대학 정보**: 28개 도메인, 6,976개 문서 기반 포괄적 답변
...
### 📊 현재 데이터 현황 (2025.07.28)
- **총 문서**: 6,976개
- **처리된 도메인**: 28개
- **크롤링 페이지**: 5,118개
- **데이터 소스**:
  - `timetable`: 교수별 강의 정보 (~105개)
  - `announcement`: 수강신청 안내 (~1,895개)
  - `website`: 대진대 전체 홈페이지 (~4,976개)
